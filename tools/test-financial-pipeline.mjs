...
assert.equal(index39Amounts.get("umsatzerlose").current,185_000_000,"index39 GuV must aggregate all mapped detail targets into the visible revenue line");
assert.equal(index39Amounts.get("umsatzerlose").prior,170_000_000);
